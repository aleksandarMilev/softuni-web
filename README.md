...
![1-cert](https://github.com/aleksandarMilev/softuni-web/blob/master/01-programming-basics-c-sharp/certificate.jpeg)
...
![2-cert](https://github.com/aleksandarMilev/softuni-web/blob/master/02-programming-fundamentals-c-sharp/certificate.jpeg)
...
![3-cert](https://github.com/aleksandarMilev/softuni-web/blob/master/03-c-sharp-advanced/certificate.jpeg)
...
![4-cert](https://github.com/aleksandarMilev/softuni-web/blob/master/04-c-sharp-oop/certificate.jpeg)
...
![5-cert](https://github.com/aleksandarMilev/softuni-web/blob/master/05-html-and-css/certificate.jpeg)
...
![6-cert](https://github.com/aleksandarMilev/softuni-web/blob/master/06-js-front-end/certificate.jpeg)
...
![7-cert](https://github.com/aleksandarMilev/softuni-web/blob/master/07-mssql/certificate.jpeg)
...
![8-cert](https://github.com/aleksandarMilev/softuni-web/blob/master/08-entity-framework-core/certificate.jpeg)
...
![9-cert](https://github.com/aleksandarMilev/softuni-web/blob/master/09-asp-net-core-fundamentals/regular-exam/DeskMarket_Skeleton/certificate.jpeg)

## ASP.NET Core Advanced

Builds on the fundamentals of ASP.NET Core by focusing on advanced techniques for creating secure, scalable, and fully featured MVC and Web API applications.

### Core Topics Covered

- **Advanced MVC & Razor**: Complex routing, model binding, validation, partials, and view components.
- **Middleware & Filters**: Custom logic in the request pipeline and centralized cross-cutting concerns.
- **EF Core** (Advanced): Complex queries, relationships, migrations, and SQL Server integration.
- **Identity & Security**: Users, roles, external logins, JWT, and modern web security practices.
- **Web API Development**: RESTful services, serialization, versioning, and API security.
- **AJAX & Dynamic Content**: Client–server communication and partial updates.
- **SignalR**: Real-time communication with WebSockets.
- **Caching & Performance**: In-memory, distributed, and response caching.
- **Testing**: Unit and integration testing for ASP.NET Core apps.
- **Azure & Deployment**: Hosting, CI/CD pipelines, and cloud deployment workflows.
- **Practical Workshops**: Building a complete end-to-end MVC/Web API project.
...
Provides the knowledge and practical skills needed to build modern Single Page Applications (SPA) using React - one of the most widely used and efficient front-end libraries for creating dynamic user interfaces.

### Core Topics Covered

- **React & JSX Basics**: Understanding JSX syntax, components, props, and rendering logic.
- **Component Architecture**: Structuring applications using reusable, component-based design.
- **Routing & Views**: Implementing client-side routing and navigation in SPA applications.
- **Forms & Validation**: Handling user input, controlled components, and form validation.
- **State Management**: Managing application state using React Hooks and Context API.
- **Data Fetching**: Working with REST APIs, Promises, and asynchronous operations.
- **Styling Techniques**: Applying styles using CSS Modules, Styled Components, and modern patterns.
- **Advanced Features**: Authentication flows, advanced hooks, and architectural patterns.
- **Testing**: Writing unit tests with Jest and building confidence in application reliability.
- **Practical Workshops**: Hands-on exercises and building a complete end-to-end React SPA.
...
![12-cert](https://github.com/aleksandarMilev/softuni-web/blob/master/10-express-js/certificate.jpg)

## TypeScript

Explores the core data types and essential features of the **TypeScript** language:
